...
function SignUp() {
  ...
  return (
    <div className="flex items-center justify-center w-full">
      <div className="mx-auto max-w-4xl min-w-3xl h-auto rounded-xl p-10 border border-emerald-600 bg-slate-900">
        <div className="flex mb-2 justify-center">
          <Link to="/">
            <Logo Class="lg:w-50 md:w-50 sm:w-40 w-40 mt-1 mb-1" />
          </Link>
        </div>
        <h2 className="leading-tight font-bold text-white text-2xl text-center">
        ...
        <form className="mt-6" onSubmit={handleSubmit(signup)}>
          <div className="space-y-5">
            ...
            />
            {errors.email && (
              <span className="text-base text-orange-500 text-center">
